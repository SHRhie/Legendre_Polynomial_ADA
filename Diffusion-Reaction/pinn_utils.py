...
class Build_PINN():
    ...
    def init_model_FF(self):
        ...
        model.add(FourierFeatures(self.ff_features, self.ff_sigma, seed=self.ff_seed))
...
class Solver_PINN():
    def __init__(self, pinn, properties, loss_dict, N_0=150, N_b=150, N_r=2500, show=False, DTYPE='float32', lr=1e-2):
        self.lr_init = lr
        self.ref_pinn = None
